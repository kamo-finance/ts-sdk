...
export class UnverifiedValidatorOperationCap implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: UnverifiedValidatorOperationCapFields, ) { this.$fullTypeName = composeSuiType( UnverifiedValidatorOperationCap.$typeName, ...typeArgs ) as `${typeof PKG_V17}::validator_cap::UnverifiedValidatorOperationCap`; this.$typeArgs = typeArgs;
...
export class ValidatorOperationCap implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: ValidatorOperationCapFields, ) { this.$fullTypeName = composeSuiType( ValidatorOperationCap.$typeName, ...typeArgs ) as `${typeof PKG_V17}::validator_cap::ValidatorOperationCap`; this.$typeArgs = typeArgs;
