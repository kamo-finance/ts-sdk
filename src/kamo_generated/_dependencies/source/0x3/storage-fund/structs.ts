...
export class StorageFund implements StructClass { __StructClass = true as const;
 ...
 private constructor(typeArgs: [], fields: StorageFundFields, ) { this.$fullTypeName = composeSuiType( StorageFund.$typeName, ...typeArgs ) as `${typeof PKG_V17}::storage_fund::StorageFund`; this.$typeArgs = typeArgs;
