...
export function isConvertingToFungibleStakedSuiEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`; }
...
export class ConvertingToFungibleStakedSuiEvent implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ConvertingToFungibleStakedSuiEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`; readonly $typeArgs: []; readonly $isPhantom = ConvertingToFungibleStakedSuiEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ConvertingToFungibleStakedSuiEventFields, ) { this.$fullTypeName = composeSuiType( ConvertingToFungibleStakedSuiEvent.$typeName, ...typeArgs ) as `${typeof PKG_V16}::validator::ConvertingToFungibleStakedSuiEvent`; this.$typeArgs = typeArgs;
...
export function isRedeemingFungibleStakedSuiEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`; }
...
export class RedeemingFungibleStakedSuiEvent implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = RedeemingFungibleStakedSuiEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`; readonly $typeArgs: []; readonly $isPhantom = RedeemingFungibleStakedSuiEvent.$isPhantom;

 readonly poolId: ToField<ID>; readonly fungibleStakedSuiAmount: ToField<"u64">; readonly suiAmount: ToField<"u64">

 private constructor(typeArgs: [], fields: RedeemingFungibleStakedSuiEventFields, ) { this.$fullTypeName = composeSuiType( RedeemingFungibleStakedSuiEvent.$typeName, ...typeArgs ) as `${typeof PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`; this.$typeArgs = typeArgs;

 this.poolId = fields.poolId;; this.fungibleStakedSuiAmount = fields.fungibleStakedSuiAmount;; this.suiAmount = fields.suiAmount; }

 static reified( ): RedeemingFungibleStakedSuiEventReified { return { typeName: RedeemingFungibleStakedSuiEvent.$typeName, fullTypeName: composeSuiType( RedeemingFungibleStakedSuiEvent.$typeName, ...[] ) as `${typeof PKG_V16}::validator::RedeemingFungibleStakedSuiEvent`, typeArgs: [ ] as [], isPhantom: RedeemingFungibleStakedSuiEvent.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => RedeemingFungibleStakedSuiEvent.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => RedeemingFungibleStakedSuiEvent.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => RedeemingFungibleStakedSuiEvent.fromBcs( data, ), bcs: RedeemingFungibleStakedSuiEvent.bcs, fromJSONField: (field: any) => RedeemingFungibleStakedSuiEvent.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => RedeemingFungibleStakedSuiEvent.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => RedeemingFungibleStakedSuiEvent.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => RedeemingFungibleStakedSuiEvent.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => RedeemingFungibleStakedSuiEvent.fetch( client, id, ), new: ( fields: RedeemingFungibleStakedSuiEventFields, ) => { return new RedeemingFungibleStakedSuiEvent( [], fields ) }, kind: "StructClassReified", } }
...
export function isStakingRequestEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::validator::StakingRequestEvent`; }
...
export class StakingRequestEvent implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::validator::StakingRequestEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StakingRequestEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::validator::StakingRequestEvent`; readonly $typeArgs: []; readonly $isPhantom = StakingRequestEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: StakingRequestEventFields, ) { this.$fullTypeName = composeSuiType( StakingRequestEvent.$typeName, ...typeArgs ) as `${typeof PKG_V16}::validator::StakingRequestEvent`; this.$typeArgs = typeArgs;
...
export function isUnstakingRequestEvent(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::validator::UnstakingRequestEvent`; }
...
export class UnstakingRequestEvent implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::validator::UnstakingRequestEvent`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UnstakingRequestEvent.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::validator::UnstakingRequestEvent`; readonly $typeArgs: []; readonly $isPhantom = UnstakingRequestEvent.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: UnstakingRequestEventFields, ) { this.$fullTypeName = composeSuiType( UnstakingRequestEvent.$typeName, ...typeArgs ) as `${typeof PKG_V16}::validator::UnstakingRequestEvent`; this.$typeArgs = typeArgs;
...
export function isValidator(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::validator::Validator`; }
...
export class Validator implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::validator::Validator`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = Validator.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::validator::Validator`; readonly $typeArgs: []; readonly $isPhantom = Validator.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ValidatorFields, ) { this.$fullTypeName = composeSuiType( Validator.$typeName, ...typeArgs ) as `${typeof PKG_V16}::validator::Validator`; this.$typeArgs = typeArgs;
...
export function isValidatorMetadata(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::validator::ValidatorMetadata`; }
...
export class ValidatorMetadata implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::validator::ValidatorMetadata`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = ValidatorMetadata.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::validator::ValidatorMetadata`; readonly $typeArgs: []; readonly $isPhantom = ValidatorMetadata.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: ValidatorMetadataFields, ) { this.$fullTypeName = composeSuiType( ValidatorMetadata.$typeName, ...typeArgs ) as `${typeof PKG_V16}::validator::ValidatorMetadata`; this.$typeArgs = typeArgs;
 ...
 static reified( ): ValidatorMetadataReified { return { typeName: ValidatorMetadata.$typeName, fullTypeName: composeSuiType( ValidatorMetadata.$typeName, ...[] ) as `${typeof PKG_V16}::validator::ValidatorMetadata`, typeArgs: [ ] as [], isPhantom: ValidatorMetadata.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => ValidatorMetadata.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => ValidatorMetadata.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => ValidatorMetadata.fromBcs( data, ), bcs: ValidatorMetadata.bcs, fromJSONField: (field: any) => ValidatorMetadata.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => ValidatorMetadata.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => ValidatorMetadata.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => ValidatorMetadata.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => ValidatorMetadata.fetch( client, id, ), new: ( fields: ValidatorMetadataFields, ) => { return new ValidatorMetadata( [], fields ) }, kind: "StructClassReified", } }
