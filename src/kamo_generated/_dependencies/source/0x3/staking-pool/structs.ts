...
export function isFungibleStakedSui(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::staking_pool::FungibleStakedSui`; }
...
export function isFungibleStakedSuiData(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::staking_pool::FungibleStakedSuiData`; }
...
export function isFungibleStakedSuiDataKey(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::staking_pool::FungibleStakedSuiDataKey`; }
...
export function isPoolTokenExchangeRate(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::staking_pool::PoolTokenExchangeRate`; }
...
export function isStakedSui(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::staking_pool::StakedSui`; }
...
export class StakedSui implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::staking_pool::StakedSui`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StakedSui.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::staking_pool::StakedSui`; readonly $typeArgs: []; readonly $isPhantom = StakedSui.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: StakedSuiFields, ) { this.$fullTypeName = composeSuiType( StakedSui.$typeName, ...typeArgs ) as `${typeof PKG_V16}::staking_pool::StakedSui`; this.$typeArgs = typeArgs;
...
export function isStakingPool(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V16}::staking_pool::StakingPool`; }
...
export class StakingPool implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V16}::staking_pool::StakingPool`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = StakingPool.$typeName; readonly $fullTypeName: `${typeof PKG_V16}::staking_pool::StakingPool`; readonly $typeArgs: []; readonly $isPhantom = StakingPool.$isPhantom;
 ...
 private constructor(typeArgs: [], fields: StakingPoolFields, ) { this.$fullTypeName = composeSuiType( StakingPool.$typeName, ...typeArgs ) as `${typeof PKG_V16}::staking_pool::StakingPool`; this.$typeArgs = typeArgs;
