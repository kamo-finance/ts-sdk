...
export interface AddLiquidityEventFields<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> { ptAmountIn: ToField<"u64">; syAmountIn: ToField<"u64">; lpAmountOut: ToField<"u64">; syExchangeRate: ToField<FixedPoint64>; sender: ToField<"address">; isBootstrap: ToField<"bool">; lnImpliedRateAfterAction: ToField<FixedPoint64>; totalPtAfterAction: ToField<"u64">; totalSyAfterAction: ToField<"u64">; lpSupplyAfterAction: ToField<"u64"> }
...
export class AddLiquidityEvent<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly ptAmountIn: ToField<"u64">; readonly syAmountIn: ToField<"u64">; readonly lpAmountOut: ToField<"u64">; readonly syExchangeRate: ToField<FixedPoint64>; readonly sender: ToField<"address">; readonly isBootstrap: ToField<"bool">; readonly lnImpliedRateAfterAction: ToField<FixedPoint64>; readonly totalPtAfterAction: ToField<"u64">; readonly totalSyAfterAction: ToField<"u64">; readonly lpSupplyAfterAction: ToField<"u64">
 ...
 this.ptAmountIn = fields.ptAmountIn;; this.syAmountIn = fields.syAmountIn;; this.lpAmountOut = fields.lpAmountOut;; this.syExchangeRate = fields.syExchangeRate;; this.sender = fields.sender;; this.isBootstrap = fields.isBootstrap;; this.lnImpliedRateAfterAction = fields.lnImpliedRateAfterAction;; this.totalPtAfterAction = fields.totalPtAfterAction;; this.totalSyAfterAction = fields.totalSyAfterAction;; this.lpSupplyAfterAction = fields.lpSupplyAfterAction; }
 ...
 pt_amount_in: bcs.u64(), sy_amount_in: bcs.u64(), lp_amount_out: bcs.u64(), sy_exchange_rate: FixedPoint64.bcs, sender: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), is_bootstrap: bcs.bool(), ln_implied_rate_after_action: FixedPoint64.bcs, total_pt_after_action: bcs.u64(), total_sy_after_action: bcs.u64(), lp_supply_after_action: bcs.u64()

}) };

 static fromFields<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], fields: Record<string, any> ): AddLiquidityEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return AddLiquidityEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountIn: decodeFromFields("u64", fields.pt_amount_in), syAmountIn: decodeFromFields("u64", fields.sy_amount_in), lpAmountOut: decodeFromFields("u64", fields.lp_amount_out), syExchangeRate: decodeFromFields(FixedPoint64.reified(), fields.sy_exchange_rate), sender: decodeFromFields("address", fields.sender), isBootstrap: decodeFromFields("bool", fields.is_bootstrap), lnImpliedRateAfterAction: decodeFromFields(FixedPoint64.reified(), fields.ln_implied_rate_after_action), totalPtAfterAction: decodeFromFields("u64", fields.total_pt_after_action), totalSyAfterAction: decodeFromFields("u64", fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFields("u64", fields.lp_supply_after_action) } ) }
 ...
 return AddLiquidityEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountIn: decodeFromFieldsWithTypes("u64", item.fields.pt_amount_in), syAmountIn: decodeFromFieldsWithTypes("u64", item.fields.sy_amount_in), lpAmountOut: decodeFromFieldsWithTypes("u64", item.fields.lp_amount_out), syExchangeRate: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.sy_exchange_rate), sender: decodeFromFieldsWithTypes("address", item.fields.sender), isBootstrap: decodeFromFieldsWithTypes("bool", item.fields.is_bootstrap), lnImpliedRateAfterAction: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.ln_implied_rate_after_action), totalPtAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_pt_after_action), totalSyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.lp_supply_after_action) } ) }
 ...
 ptAmountIn: this.ptAmountIn.toString(),syAmountIn: this.syAmountIn.toString(),lpAmountOut: this.lpAmountOut.toString(),syExchangeRate: this.syExchangeRate.toJSONField(),sender: this.sender,isBootstrap: this.isBootstrap,lnImpliedRateAfterAction: this.lnImpliedRateAfterAction.toJSONField(),totalPtAfterAction: this.totalPtAfterAction.toString(),totalSyAfterAction: this.totalSyAfterAction.toString(),lpSupplyAfterAction: this.lpSupplyAfterAction.toString(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], field: any ): AddLiquidityEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return AddLiquidityEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountIn: decodeFromJSONField("u64", field.ptAmountIn), syAmountIn: decodeFromJSONField("u64", field.syAmountIn), lpAmountOut: decodeFromJSONField("u64", field.lpAmountOut), syExchangeRate: decodeFromJSONField(FixedPoint64.reified(), field.syExchangeRate), sender: decodeFromJSONField("address", field.sender), isBootstrap: decodeFromJSONField("bool", field.isBootstrap), lnImpliedRateAfterAction: decodeFromJSONField(FixedPoint64.reified(), field.lnImpliedRateAfterAction), totalPtAfterAction: decodeFromJSONField("u64", field.totalPtAfterAction), totalSyAfterAction: decodeFromJSONField("u64", field.totalSyAfterAction), lpSupplyAfterAction: decodeFromJSONField("u64", field.lpSupplyAfterAction) } ) }
...
export interface RemoveLiquidityEventFields<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> { ptAmountOut: ToField<"u64">; syAmountOut: ToField<"u64">; lpAmountIn: ToField<"u64">; sender: ToField<"address">; totalPtAfterAction: ToField<"u64">; totalSyAfterAction: ToField<"u64">; lpSupplyAfterAction: ToField<"u64"> }
...
export class RemoveLiquidityEvent<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly ptAmountOut: ToField<"u64">; readonly syAmountOut: ToField<"u64">; readonly lpAmountIn: ToField<"u64">; readonly sender: ToField<"address">; readonly totalPtAfterAction: ToField<"u64">; readonly totalSyAfterAction: ToField<"u64">; readonly lpSupplyAfterAction: ToField<"u64">
 ...
 this.ptAmountOut = fields.ptAmountOut;; this.syAmountOut = fields.syAmountOut;; this.lpAmountIn = fields.lpAmountIn;; this.sender = fields.sender;; this.totalPtAfterAction = fields.totalPtAfterAction;; this.totalSyAfterAction = fields.totalSyAfterAction;; this.lpSupplyAfterAction = fields.lpSupplyAfterAction; }
 ...
 pt_amount_out: bcs.u64(), sy_amount_out: bcs.u64(), lp_amount_in: bcs.u64(), sender: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), total_pt_after_action: bcs.u64(), total_sy_after_action: bcs.u64(), lp_supply_after_action: bcs.u64()

}) };

 static fromFields<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], fields: Record<string, any> ): RemoveLiquidityEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return RemoveLiquidityEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountOut: decodeFromFields("u64", fields.pt_amount_out), syAmountOut: decodeFromFields("u64", fields.sy_amount_out), lpAmountIn: decodeFromFields("u64", fields.lp_amount_in), sender: decodeFromFields("address", fields.sender), totalPtAfterAction: decodeFromFields("u64", fields.total_pt_after_action), totalSyAfterAction: decodeFromFields("u64", fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFields("u64", fields.lp_supply_after_action) } ) }
 ...
 return RemoveLiquidityEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountOut: decodeFromFieldsWithTypes("u64", item.fields.pt_amount_out), syAmountOut: decodeFromFieldsWithTypes("u64", item.fields.sy_amount_out), lpAmountIn: decodeFromFieldsWithTypes("u64", item.fields.lp_amount_in), sender: decodeFromFieldsWithTypes("address", item.fields.sender), totalPtAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_pt_after_action), totalSyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.lp_supply_after_action) } ) }
 ...
 ptAmountOut: this.ptAmountOut.toString(),syAmountOut: this.syAmountOut.toString(),lpAmountIn: this.lpAmountIn.toString(),sender: this.sender,totalPtAfterAction: this.totalPtAfterAction.toString(),totalSyAfterAction: this.totalSyAfterAction.toString(),lpSupplyAfterAction: this.lpSupplyAfterAction.toString(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], field: any ): RemoveLiquidityEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return RemoveLiquidityEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountOut: decodeFromJSONField("u64", field.ptAmountOut), syAmountOut: decodeFromJSONField("u64", field.syAmountOut), lpAmountIn: decodeFromJSONField("u64", field.lpAmountIn), sender: decodeFromJSONField("address", field.sender), totalPtAfterAction: decodeFromJSONField("u64", field.totalPtAfterAction), totalSyAfterAction: decodeFromJSONField("u64", field.totalSyAfterAction), lpSupplyAfterAction: decodeFromJSONField("u64", field.lpSupplyAfterAction) } ) }
...
export interface SwapExactPtForSyEventFields<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> { ptAmountIn: ToField<"u64">; syAmountOut: ToField<"u64">; syFeeAmount: ToField<"u64">; syExchangeRate: ToField<FixedPoint64>; swapExchangeRate: ToField<FixedPoint64>; lnImpliedRateAfterAction: ToField<FixedPoint64>; sender: ToField<"address">; totalPtAfterAction: ToField<"u64">; totalSyAfterAction: ToField<"u64">; lpSupplyAfterAction: ToField<"u64"> }
...
export class SwapExactPtForSyEvent<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly ptAmountIn: ToField<"u64">; readonly syAmountOut: ToField<"u64">; readonly syFeeAmount: ToField<"u64">; readonly syExchangeRate: ToField<FixedPoint64>; readonly swapExchangeRate: ToField<FixedPoint64>; readonly lnImpliedRateAfterAction: ToField<FixedPoint64>; readonly sender: ToField<"address">; readonly totalPtAfterAction: ToField<"u64">; readonly totalSyAfterAction: ToField<"u64">; readonly lpSupplyAfterAction: ToField<"u64">
 ...
 this.ptAmountIn = fields.ptAmountIn;; this.syAmountOut = fields.syAmountOut;; this.syFeeAmount = fields.syFeeAmount;; this.syExchangeRate = fields.syExchangeRate;; this.swapExchangeRate = fields.swapExchangeRate;; this.lnImpliedRateAfterAction = fields.lnImpliedRateAfterAction;; this.sender = fields.sender;; this.totalPtAfterAction = fields.totalPtAfterAction;; this.totalSyAfterAction = fields.totalSyAfterAction;; this.lpSupplyAfterAction = fields.lpSupplyAfterAction; }
 ...
 pt_amount_in: bcs.u64(), sy_amount_out: bcs.u64(), sy_fee_amount: bcs.u64(), sy_exchange_rate: FixedPoint64.bcs, swap_exchange_rate: FixedPoint64.bcs, ln_implied_rate_after_action: FixedPoint64.bcs, sender: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), total_pt_after_action: bcs.u64(), total_sy_after_action: bcs.u64(), lp_supply_after_action: bcs.u64()

}) };

 static fromFields<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], fields: Record<string, any> ): SwapExactPtForSyEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return SwapExactPtForSyEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountIn: decodeFromFields("u64", fields.pt_amount_in), syAmountOut: decodeFromFields("u64", fields.sy_amount_out), syFeeAmount: decodeFromFields("u64", fields.sy_fee_amount), syExchangeRate: decodeFromFields(FixedPoint64.reified(), fields.sy_exchange_rate), swapExchangeRate: decodeFromFields(FixedPoint64.reified(), fields.swap_exchange_rate), lnImpliedRateAfterAction: decodeFromFields(FixedPoint64.reified(), fields.ln_implied_rate_after_action), sender: decodeFromFields("address", fields.sender), totalPtAfterAction: decodeFromFields("u64", fields.total_pt_after_action), totalSyAfterAction: decodeFromFields("u64", fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFields("u64", fields.lp_supply_after_action) } ) }
 ...
 return SwapExactPtForSyEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountIn: decodeFromFieldsWithTypes("u64", item.fields.pt_amount_in), syAmountOut: decodeFromFieldsWithTypes("u64", item.fields.sy_amount_out), syFeeAmount: decodeFromFieldsWithTypes("u64", item.fields.sy_fee_amount), syExchangeRate: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.sy_exchange_rate), swapExchangeRate: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.swap_exchange_rate), lnImpliedRateAfterAction: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.ln_implied_rate_after_action), sender: decodeFromFieldsWithTypes("address", item.fields.sender), totalPtAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_pt_after_action), totalSyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.lp_supply_after_action) } ) }
 ...
 ptAmountIn: this.ptAmountIn.toString(),syAmountOut: this.syAmountOut.toString(),syFeeAmount: this.syFeeAmount.toString(),syExchangeRate: this.syExchangeRate.toJSONField(),swapExchangeRate: this.swapExchangeRate.toJSONField(),lnImpliedRateAfterAction: this.lnImpliedRateAfterAction.toJSONField(),sender: this.sender,totalPtAfterAction: this.totalPtAfterAction.toString(),totalSyAfterAction: this.totalSyAfterAction.toString(),lpSupplyAfterAction: this.lpSupplyAfterAction.toString(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], field: any ): SwapExactPtForSyEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return SwapExactPtForSyEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountIn: decodeFromJSONField("u64", field.ptAmountIn), syAmountOut: decodeFromJSONField("u64", field.syAmountOut), syFeeAmount: decodeFromJSONField("u64", field.syFeeAmount), syExchangeRate: decodeFromJSONField(FixedPoint64.reified(), field.syExchangeRate), swapExchangeRate: decodeFromJSONField(FixedPoint64.reified(), field.swapExchangeRate), lnImpliedRateAfterAction: decodeFromJSONField(FixedPoint64.reified(), field.lnImpliedRateAfterAction), sender: decodeFromJSONField("address", field.sender), totalPtAfterAction: decodeFromJSONField("u64", field.totalPtAfterAction), totalSyAfterAction: decodeFromJSONField("u64", field.totalSyAfterAction), lpSupplyAfterAction: decodeFromJSONField("u64", field.lpSupplyAfterAction) } ) }
...
export interface SwapSyForExactPtEventFields<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> { ptAmountOut: ToField<"u64">; syAmountIn: ToField<"u64">; syFeeAmount: ToField<"u64">; syExchangeRate: ToField<FixedPoint64>; swapExchangeRate: ToField<FixedPoint64>; lnImpliedRateAfterAction: ToField<FixedPoint64>; sender: ToField<"address">; totalPtAfterAction: ToField<"u64">; totalSyAfterAction: ToField<"u64">; lpSupplyAfterAction: ToField<"u64"> }
...
export class SwapSyForExactPtEvent<PT extends PhantomTypeArgument, SY extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly ptAmountOut: ToField<"u64">; readonly syAmountIn: ToField<"u64">; readonly syFeeAmount: ToField<"u64">; readonly syExchangeRate: ToField<FixedPoint64>; readonly swapExchangeRate: ToField<FixedPoint64>; readonly lnImpliedRateAfterAction: ToField<FixedPoint64>; readonly sender: ToField<"address">; readonly totalPtAfterAction: ToField<"u64">; readonly totalSyAfterAction: ToField<"u64">; readonly lpSupplyAfterAction: ToField<"u64">
 ...
 this.ptAmountOut = fields.ptAmountOut;; this.syAmountIn = fields.syAmountIn;; this.syFeeAmount = fields.syFeeAmount;; this.syExchangeRate = fields.syExchangeRate;; this.swapExchangeRate = fields.swapExchangeRate;; this.lnImpliedRateAfterAction = fields.lnImpliedRateAfterAction;; this.sender = fields.sender;; this.totalPtAfterAction = fields.totalPtAfterAction;; this.totalSyAfterAction = fields.totalSyAfterAction;; this.lpSupplyAfterAction = fields.lpSupplyAfterAction; }
 ...
 pt_amount_out: bcs.u64(), sy_amount_in: bcs.u64(), sy_fee_amount: bcs.u64(), sy_exchange_rate: FixedPoint64.bcs, swap_exchange_rate: FixedPoint64.bcs, ln_implied_rate_after_action: FixedPoint64.bcs, sender: bcs.bytes(32).transform({ input: (val: string) => fromHEX(val), output: (val: Uint8Array) => toHEX(val), }), total_pt_after_action: bcs.u64(), total_sy_after_action: bcs.u64(), lp_supply_after_action: bcs.u64()

}) };

 static fromFields<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], fields: Record<string, any> ): SwapSyForExactPtEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return SwapSyForExactPtEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountOut: decodeFromFields("u64", fields.pt_amount_out), syAmountIn: decodeFromFields("u64", fields.sy_amount_in), syFeeAmount: decodeFromFields("u64", fields.sy_fee_amount), syExchangeRate: decodeFromFields(FixedPoint64.reified(), fields.sy_exchange_rate), swapExchangeRate: decodeFromFields(FixedPoint64.reified(), fields.swap_exchange_rate), lnImpliedRateAfterAction: decodeFromFields(FixedPoint64.reified(), fields.ln_implied_rate_after_action), sender: decodeFromFields("address", fields.sender), totalPtAfterAction: decodeFromFields("u64", fields.total_pt_after_action), totalSyAfterAction: decodeFromFields("u64", fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFields("u64", fields.lp_supply_after_action) } ) }
 ...
 return SwapSyForExactPtEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountOut: decodeFromFieldsWithTypes("u64", item.fields.pt_amount_out), syAmountIn: decodeFromFieldsWithTypes("u64", item.fields.sy_amount_in), syFeeAmount: decodeFromFieldsWithTypes("u64", item.fields.sy_fee_amount), syExchangeRate: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.sy_exchange_rate), swapExchangeRate: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.swap_exchange_rate), lnImpliedRateAfterAction: decodeFromFieldsWithTypes(FixedPoint64.reified(), item.fields.ln_implied_rate_after_action), sender: decodeFromFieldsWithTypes("address", item.fields.sender), totalPtAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_pt_after_action), totalSyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.total_sy_after_action), lpSupplyAfterAction: decodeFromFieldsWithTypes("u64", item.fields.lp_supply_after_action) } ) }
 ...
 ptAmountOut: this.ptAmountOut.toString(),syAmountIn: this.syAmountIn.toString(),syFeeAmount: this.syFeeAmount.toString(),syExchangeRate: this.syExchangeRate.toJSONField(),swapExchangeRate: this.swapExchangeRate.toJSONField(),lnImpliedRateAfterAction: this.lnImpliedRateAfterAction.toJSONField(),sender: this.sender,totalPtAfterAction: this.totalPtAfterAction.toString(),totalSyAfterAction: this.totalSyAfterAction.toString(),lpSupplyAfterAction: this.lpSupplyAfterAction.toString(),

} }

 toJSON() { return { $typeName: this.$typeName, $typeArgs: this.$typeArgs, ...this.toJSONField() } }

 static fromJSONField<PT extends PhantomReified<PhantomTypeArgument>, SY extends PhantomReified<PhantomTypeArgument>>( typeArgs: [PT, SY], field: any ): SwapSyForExactPtEvent<ToPhantomTypeArgument<PT>, ToPhantomTypeArgument<SY>> { return SwapSyForExactPtEvent.reified( typeArgs[0], typeArgs[1], ).new( { ptAmountOut: decodeFromJSONField("u64", field.ptAmountOut), syAmountIn: decodeFromJSONField("u64", field.syAmountIn), syFeeAmount: decodeFromJSONField("u64", field.syFeeAmount), syExchangeRate: decodeFromJSONField(FixedPoint64.reified(), field.syExchangeRate), swapExchangeRate: decodeFromJSONField(FixedPoint64.reified(), field.swapExchangeRate), lnImpliedRateAfterAction: decodeFromJSONField(FixedPoint64.reified(), field.lnImpliedRateAfterAction), sender: decodeFromJSONField("address", field.sender), totalPtAfterAction: decodeFromJSONField("u64", field.totalPtAfterAction), totalSyAfterAction: decodeFromJSONField("u64", field.totalSyAfterAction), lpSupplyAfterAction: decodeFromJSONField("u64", field.lpSupplyAfterAction) } ) }
