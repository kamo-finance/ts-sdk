...
export interface StateFields { id: ToField<UID>; market: ToField<Market<ToPhantom<PT>, ToPhantom<KUSDC>>>; registry: ToField<Registry<ToPhantom<PT>, ToPhantom<KUSDC>>> }
...
export class State implements StructClass { __StructClass = true as const;
 ...
 readonly id: ToField<UID>; readonly market: ToField<Market<ToPhantom<PT>, ToPhantom<KUSDC>>>; readonly registry: ToField<Registry<ToPhantom<PT>, ToPhantom<KUSDC>>>
 ...
 static fromFields( fields: Record<string, any> ): State { return State.reified( ).new( { id: decodeFromFields(UID.reified(), fields.id), market: decodeFromFields(Market.reified(reified.phantom(PT.reified()), reified.phantom(KUSDC.reified())), fields.market), registry: decodeFromFields(Registry.reified(reified.phantom(PT.reified()), reified.phantom(KUSDC.reified())), fields.registry) } ) }

 static fromFieldsWithTypes( item: FieldsWithTypes ): State { if (!isState(item.type)) { throw new Error("not a State type");

 }

 return State.reified( ).new( { id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), market: decodeFromFieldsWithTypes(Market.reified(reified.phantom(PT.reified()), reified.phantom(KUSDC.reified())), item.fields.market), registry: decodeFromFieldsWithTypes(Registry.reified(reified.phantom(PT.reified()), reified.phantom(KUSDC.reified())), item.fields.registry) } ) }
 ...
 static fromJSONField( field: any ): State { return State.reified( ).new( { id: decodeFromJSONField(UID.reified(), field.id), market: decodeFromJSONField(Market.reified(reified.phantom(PT.reified()), reified.phantom(KUSDC.reified())), field.market), registry: decodeFromJSONField(Registry.reified(reified.phantom(PT.reified()), reified.phantom(KUSDC.reified())), field.registry) } ) }
