...
export interface BlocklisterChangedFields<T extends PhantomTypeArgument> { oldBlocklister: ToField<"address">; newBlocklister: ToField<"address"> }

export type BlocklisterChangedReified<T extends PhantomTypeArgument> = Reified< BlocklisterChanged<T>, BlocklisterChangedFields<T> >;

export class BlocklisterChanged<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = BlocklisterChanged.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::roles::BlocklisterChanged<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = BlocklisterChanged.$isPhantom;

 readonly oldBlocklister: ToField<"address">; readonly newBlocklister: ToField<"address">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: BlocklisterChangedFields<T>, ) { this.$fullTypeName = composeSuiType( BlocklisterChanged.$typeName, ...typeArgs ) as `${typeof PKG_V1}::roles::BlocklisterChanged<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.oldBlocklister = fields.oldBlocklister;; this.newBlocklister = fields.newBlocklister; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): BlocklisterChangedReified<ToPhantomTypeArgument<T>> { return { typeName: BlocklisterChanged.$typeName, fullTypeName: composeSuiType( BlocklisterChanged.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::roles::BlocklisterChanged<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: BlocklisterChanged.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => BlocklisterChanged.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => BlocklisterChanged.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => BlocklisterChanged.fromBcs( T, data, ), bcs: BlocklisterChanged.bcs, fromJSONField: (field: any) => BlocklisterChanged.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => BlocklisterChanged.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => BlocklisterChanged.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => BlocklisterChanged.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => BlocklisterChanged.fetch( client, T, id, ), new: ( fields: BlocklisterChangedFields<ToPhantomTypeArgument<T>>, ) => { return new BlocklisterChanged( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return BlocklisterChanged.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<BlocklisterChanged<ToPhantomTypeArgument<T>>>> { return phantom(BlocklisterChanged.reified( T )); } static get p() { return BlocklisterChanged.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): BlocklisterChanged<ToPhantomTypeArgument<T>> { return BlocklisterChanged.reified( typeArg, ).new( { oldBlocklister: decodeFromFields("address", fields.old_blocklister), newBlocklister: decodeFromFields("address", fields.new_blocklister) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): BlocklisterChanged<ToPhantomTypeArgument<T>> { if (!isBlocklisterChanged(item.type)) { throw new Error("not a BlocklisterChanged type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): BlocklisterChanged<ToPhantomTypeArgument<T>> { return BlocklisterChanged.fromFields( typeArg, BlocklisterChanged.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): BlocklisterChanged<ToPhantomTypeArgument<T>> { return BlocklisterChanged.reified( typeArg, ).new( { oldBlocklister: decodeFromJSONField("address", field.oldBlocklister), newBlocklister: decodeFromJSONField("address", field.newBlocklister) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): BlocklisterChanged<ToPhantomTypeArgument<T>> { if (json.$typeName !== BlocklisterChanged.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(BlocklisterChanged.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return BlocklisterChanged.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): BlocklisterChanged<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isBlocklisterChanged(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a BlocklisterChanged object`); } return BlocklisterChanged.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): BlocklisterChanged<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isBlocklisterChanged(data.bcs.type)) { throw new Error(`object at is not a BlocklisterChanged object`); }
...
export interface MasterMinterChangedFields<T extends PhantomTypeArgument> { oldMasterMinter: ToField<"address">; newMasterMinter: ToField<"address"> }

export type MasterMinterChangedReified<T extends PhantomTypeArgument> = Reified< MasterMinterChanged<T>, MasterMinterChangedFields<T> >;

export class MasterMinterChanged<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = MasterMinterChanged.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::roles::MasterMinterChanged<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = MasterMinterChanged.$isPhantom;

 readonly oldMasterMinter: ToField<"address">; readonly newMasterMinter: ToField<"address">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: MasterMinterChangedFields<T>, ) { this.$fullTypeName = composeSuiType( MasterMinterChanged.$typeName, ...typeArgs ) as `${typeof PKG_V1}::roles::MasterMinterChanged<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.oldMasterMinter = fields.oldMasterMinter;; this.newMasterMinter = fields.newMasterMinter; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): MasterMinterChangedReified<ToPhantomTypeArgument<T>> { return { typeName: MasterMinterChanged.$typeName, fullTypeName: composeSuiType( MasterMinterChanged.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::roles::MasterMinterChanged<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: MasterMinterChanged.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => MasterMinterChanged.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => MasterMinterChanged.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => MasterMinterChanged.fromBcs( T, data, ), bcs: MasterMinterChanged.bcs, fromJSONField: (field: any) => MasterMinterChanged.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => MasterMinterChanged.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => MasterMinterChanged.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => MasterMinterChanged.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => MasterMinterChanged.fetch( client, T, id, ), new: ( fields: MasterMinterChangedFields<ToPhantomTypeArgument<T>>, ) => { return new MasterMinterChanged( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return MasterMinterChanged.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<MasterMinterChanged<ToPhantomTypeArgument<T>>>> { return phantom(MasterMinterChanged.reified( T )); } static get p() { return MasterMinterChanged.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): MasterMinterChanged<ToPhantomTypeArgument<T>> { return MasterMinterChanged.reified( typeArg, ).new( { oldMasterMinter: decodeFromFields("address", fields.old_master_minter), newMasterMinter: decodeFromFields("address", fields.new_master_minter) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): MasterMinterChanged<ToPhantomTypeArgument<T>> { if (!isMasterMinterChanged(item.type)) { throw new Error("not a MasterMinterChanged type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): MasterMinterChanged<ToPhantomTypeArgument<T>> { return MasterMinterChanged.fromFields( typeArg, MasterMinterChanged.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): MasterMinterChanged<ToPhantomTypeArgument<T>> { return MasterMinterChanged.reified( typeArg, ).new( { oldMasterMinter: decodeFromJSONField("address", field.oldMasterMinter), newMasterMinter: decodeFromJSONField("address", field.newMasterMinter) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): MasterMinterChanged<ToPhantomTypeArgument<T>> { if (json.$typeName !== MasterMinterChanged.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(MasterMinterChanged.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return MasterMinterChanged.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): MasterMinterChanged<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isMasterMinterChanged(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a MasterMinterChanged object`); } return MasterMinterChanged.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): MasterMinterChanged<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMasterMinterChanged(data.bcs.type)) { throw new Error(`object at is not a MasterMinterChanged object`); }
...
export interface MetadataUpdaterChangedFields<T extends PhantomTypeArgument> { oldMetadataUpdater: ToField<"address">; newMetadataUpdater: ToField<"address"> }

export type MetadataUpdaterChangedReified<T extends PhantomTypeArgument> = Reified< MetadataUpdaterChanged<T>, MetadataUpdaterChangedFields<T> >;

export class MetadataUpdaterChanged<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = MetadataUpdaterChanged.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::roles::MetadataUpdaterChanged<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = MetadataUpdaterChanged.$isPhantom;

 readonly oldMetadataUpdater: ToField<"address">; readonly newMetadataUpdater: ToField<"address">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: MetadataUpdaterChangedFields<T>, ) { this.$fullTypeName = composeSuiType( MetadataUpdaterChanged.$typeName, ...typeArgs ) as `${typeof PKG_V1}::roles::MetadataUpdaterChanged<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.oldMetadataUpdater = fields.oldMetadataUpdater;; this.newMetadataUpdater = fields.newMetadataUpdater; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): MetadataUpdaterChangedReified<ToPhantomTypeArgument<T>> { return { typeName: MetadataUpdaterChanged.$typeName, fullTypeName: composeSuiType( MetadataUpdaterChanged.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::roles::MetadataUpdaterChanged<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: MetadataUpdaterChanged.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => MetadataUpdaterChanged.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => MetadataUpdaterChanged.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => MetadataUpdaterChanged.fromBcs( T, data, ), bcs: MetadataUpdaterChanged.bcs, fromJSONField: (field: any) => MetadataUpdaterChanged.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => MetadataUpdaterChanged.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => MetadataUpdaterChanged.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => MetadataUpdaterChanged.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => MetadataUpdaterChanged.fetch( client, T, id, ), new: ( fields: MetadataUpdaterChangedFields<ToPhantomTypeArgument<T>>, ) => { return new MetadataUpdaterChanged( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return MetadataUpdaterChanged.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<MetadataUpdaterChanged<ToPhantomTypeArgument<T>>>> { return phantom(MetadataUpdaterChanged.reified( T )); } static get p() { return MetadataUpdaterChanged.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { return MetadataUpdaterChanged.reified( typeArg, ).new( { oldMetadataUpdater: decodeFromFields("address", fields.old_metadata_updater), newMetadataUpdater: decodeFromFields("address", fields.new_metadata_updater) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { if (!isMetadataUpdaterChanged(item.type)) { throw new Error("not a MetadataUpdaterChanged type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { return MetadataUpdaterChanged.fromFields( typeArg, MetadataUpdaterChanged.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { return MetadataUpdaterChanged.reified( typeArg, ).new( { oldMetadataUpdater: decodeFromJSONField("address", field.oldMetadataUpdater), newMetadataUpdater: decodeFromJSONField("address", field.newMetadataUpdater) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { if (json.$typeName !== MetadataUpdaterChanged.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(MetadataUpdaterChanged.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return MetadataUpdaterChanged.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isMetadataUpdaterChanged(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a MetadataUpdaterChanged object`); } return MetadataUpdaterChanged.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): MetadataUpdaterChanged<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isMetadataUpdaterChanged(data.bcs.type)) { throw new Error(`object at is not a MetadataUpdaterChanged object`); }
...
export interface OwnerRoleFields<T extends PhantomTypeArgument> { dummyField: ToField<"bool"> }

export type OwnerRoleReified<T extends PhantomTypeArgument> = Reified< OwnerRole<T>, OwnerRoleFields<T> >;

export class OwnerRole<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::roles::OwnerRole`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = OwnerRole.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::roles::OwnerRole<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = OwnerRole.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: OwnerRoleFields<T>, ) { this.$fullTypeName = composeSuiType( OwnerRole.$typeName, ...typeArgs ) as `${typeof PKG_V1}::roles::OwnerRole<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): OwnerRoleReified<ToPhantomTypeArgument<T>> { return { typeName: OwnerRole.$typeName, fullTypeName: composeSuiType( OwnerRole.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::roles::OwnerRole<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: OwnerRole.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => OwnerRole.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => OwnerRole.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => OwnerRole.fromBcs( T, data, ), bcs: OwnerRole.bcs, fromJSONField: (field: any) => OwnerRole.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => OwnerRole.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => OwnerRole.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => OwnerRole.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => OwnerRole.fetch( client, T, id, ), new: ( fields: OwnerRoleFields<ToPhantomTypeArgument<T>>, ) => { return new OwnerRole( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return OwnerRole.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<OwnerRole<ToPhantomTypeArgument<T>>>> { return phantom(OwnerRole.reified( T )); } static get p() { return OwnerRole.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): OwnerRole<ToPhantomTypeArgument<T>> { return OwnerRole.reified( typeArg, ).new( { dummyField: decodeFromFields("bool", fields.dummy_field) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): OwnerRole<ToPhantomTypeArgument<T>> { if (!isOwnerRole(item.type)) { throw new Error("not a OwnerRole type");

 } assertFieldsWithTypesArgsMatch(item, [typeArg]);

 return OwnerRole.reified( typeArg, ).new( { dummyField: decodeFromFieldsWithTypes("bool", item.fields.dummy_field) } ) }

 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): OwnerRole<ToPhantomTypeArgument<T>> { return OwnerRole.fromFields( typeArg, OwnerRole.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): OwnerRole<ToPhantomTypeArgument<T>> { return OwnerRole.reified( typeArg, ).new( { dummyField: decodeFromJSONField("bool", field.dummyField) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): OwnerRole<ToPhantomTypeArgument<T>> { if (json.$typeName !== OwnerRole.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(OwnerRole.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return OwnerRole.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): OwnerRole<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isOwnerRole(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a OwnerRole object`); } return OwnerRole.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): OwnerRole<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isOwnerRole(data.bcs.type)) { throw new Error(`object at is not a OwnerRole object`); }
...
export interface PauserChangedFields<T extends PhantomTypeArgument> { oldPauser: ToField<"address">; newPauser: ToField<"address"> }

export type PauserChangedReified<T extends PhantomTypeArgument> = Reified< PauserChanged<T>, PauserChangedFields<T> >;

export class PauserChanged<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;
 ...
 readonly $typeName = PauserChanged.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::roles::PauserChanged<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = PauserChanged.$isPhantom;

 readonly oldPauser: ToField<"address">; readonly newPauser: ToField<"address">

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: PauserChangedFields<T>, ) { this.$fullTypeName = composeSuiType( PauserChanged.$typeName, ...typeArgs ) as `${typeof PKG_V1}::roles::PauserChanged<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.oldPauser = fields.oldPauser;; this.newPauser = fields.newPauser; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PauserChangedReified<ToPhantomTypeArgument<T>> { return { typeName: PauserChanged.$typeName, fullTypeName: composeSuiType( PauserChanged.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::roles::PauserChanged<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: PauserChanged.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => PauserChanged.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => PauserChanged.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => PauserChanged.fromBcs( T, data, ), bcs: PauserChanged.bcs, fromJSONField: (field: any) => PauserChanged.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => PauserChanged.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => PauserChanged.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => PauserChanged.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => PauserChanged.fetch( client, T, id, ), new: ( fields: PauserChangedFields<ToPhantomTypeArgument<T>>, ) => { return new PauserChanged( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return PauserChanged.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<PauserChanged<ToPhantomTypeArgument<T>>>> { return phantom(PauserChanged.reified( T )); } static get p() { return PauserChanged.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): PauserChanged<ToPhantomTypeArgument<T>> { return PauserChanged.reified( typeArg, ).new( { oldPauser: decodeFromFields("address", fields.old_pauser), newPauser: decodeFromFields("address", fields.new_pauser) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): PauserChanged<ToPhantomTypeArgument<T>> { if (!isPauserChanged(item.type)) { throw new Error("not a PauserChanged type");
 ...
 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): PauserChanged<ToPhantomTypeArgument<T>> { return PauserChanged.fromFields( typeArg, PauserChanged.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): PauserChanged<ToPhantomTypeArgument<T>> { return PauserChanged.reified( typeArg, ).new( { oldPauser: decodeFromJSONField("address", field.oldPauser), newPauser: decodeFromJSONField("address", field.newPauser) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): PauserChanged<ToPhantomTypeArgument<T>> { if (json.$typeName !== PauserChanged.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(PauserChanged.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return PauserChanged.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): PauserChanged<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isPauserChanged(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a PauserChanged object`); } return PauserChanged.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): PauserChanged<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isPauserChanged(data.bcs.type)) { throw new Error(`object at is not a PauserChanged object`); }
...
export interface RolesFields<T extends PhantomTypeArgument> { data: ToField<Bag> }

export type RolesReified<T extends PhantomTypeArgument> = Reified< Roles<T>, RolesFields<T> >;

export class Roles<T extends PhantomTypeArgument> implements StructClass { __StructClass = true as const;

 static readonly $typeName = `${PKG_V1}::roles::Roles`; static readonly $numTypeParams = 1; static readonly $isPhantom = [true,] as const;

 readonly $typeName = Roles.$typeName; readonly $fullTypeName: `${typeof PKG_V1}::roles::Roles<${PhantomToTypeStr<T>}>`; readonly $typeArgs: [PhantomToTypeStr<T>]; readonly $isPhantom = Roles.$isPhantom;

 readonly data: ToField<Bag>

 private constructor(typeArgs: [PhantomToTypeStr<T>], fields: RolesFields<T>, ) { this.$fullTypeName = composeSuiType( Roles.$typeName, ...typeArgs ) as `${typeof PKG_V1}::roles::Roles<${PhantomToTypeStr<T>}>`; this.$typeArgs = typeArgs;

 this.data = fields.data; }

 static reified<T extends PhantomReified<PhantomTypeArgument>>( T: T ): RolesReified<ToPhantomTypeArgument<T>> { return { typeName: Roles.$typeName, fullTypeName: composeSuiType( Roles.$typeName, ...[extractType(T)] ) as `${typeof PKG_V1}::roles::Roles<${PhantomToTypeStr<ToPhantomTypeArgument<T>>}>`, typeArgs: [ extractType(T) ] as [PhantomToTypeStr<ToPhantomTypeArgument<T>>], isPhantom: Roles.$isPhantom, reifiedTypeArgs: [T], fromFields: (fields: Record<string, any>) => Roles.fromFields( T, fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => Roles.fromFieldsWithTypes( T, item, ), fromBcs: (data: Uint8Array) => Roles.fromBcs( T, data, ), bcs: Roles.bcs, fromJSONField: (field: any) => Roles.fromJSONField( T, field, ), fromJSON: (json: Record<string, any>) => Roles.fromJSON( T, json, ), fromSuiParsedData: (content: SuiParsedData) => Roles.fromSuiParsedData( T, content, ), fromSuiObjectData: (content: SuiObjectData) => Roles.fromSuiObjectData( T, content, ), fetch: async (client: SuiClient, id: string) => Roles.fetch( client, T, id, ), new: ( fields: RolesFields<ToPhantomTypeArgument<T>>, ) => { return new Roles( [extractType(T)], fields ) }, kind: "StructClassReified", } }

 static get r() { return Roles.reified }

 static phantom<T extends PhantomReified<PhantomTypeArgument>>( T: T ): PhantomReified<ToTypeStr<Roles<ToPhantomTypeArgument<T>>>> { return phantom(Roles.reified( T )); } static get p() { return Roles.phantom }
 ...
 static fromFields<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, fields: Record<string, any> ): Roles<ToPhantomTypeArgument<T>> { return Roles.reified( typeArg, ).new( { data: decodeFromFields(Bag.reified(), fields.data) } ) }

 static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, item: FieldsWithTypes ): Roles<ToPhantomTypeArgument<T>> { if (!isRoles(item.type)) { throw new Error("not a Roles type");

 } assertFieldsWithTypesArgsMatch(item, [typeArg]);

 return Roles.reified( typeArg, ).new( { data: decodeFromFieldsWithTypes(Bag.reified(), item.fields.data) } ) }

 static fromBcs<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: Uint8Array ): Roles<ToPhantomTypeArgument<T>> { return Roles.fromFields( typeArg, Roles.bcs.parse(data) ) }
 ...
 static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, field: any ): Roles<ToPhantomTypeArgument<T>> { return Roles.reified( typeArg, ).new( { data: decodeFromJSONField(Bag.reified(), field.data) } ) }

 static fromJSON<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, json: Record<string, any> ): Roles<ToPhantomTypeArgument<T>> { if (json.$typeName !== Roles.$typeName) { throw new Error("not a WithTwoGenerics json object") }; assertReifiedTypeArgsMatch( composeSuiType(Roles.$typeName, extractType(typeArg)), json.$typeArgs, [typeArg], )

 return Roles.fromJSONField( typeArg, json, ) }

 static fromSuiParsedData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, content: SuiParsedData ): Roles<ToPhantomTypeArgument<T>> { if (content.dataType !== "moveObject") { throw new Error("not an object"); } if (!isRoles(content.type)) { throw new Error(`object at ${(content.fields as any).id} is not a Roles object`); } return Roles.fromFieldsWithTypes( typeArg, content ); }

 static fromSuiObjectData<T extends PhantomReified<PhantomTypeArgument>>( typeArg: T, data: SuiObjectData ): Roles<ToPhantomTypeArgument<T>> { if (data.bcs) { if (data.bcs.dataType !== "moveObject" || !isRoles(data.bcs.type)) { throw new Error(`object at is not a Roles object`); }
