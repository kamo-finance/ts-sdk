...
export function isUncompressedG1(type: string): boolean { type = compressSuiType(type); return type === `${PKG_V28}::bls12381::UncompressedG1`; }
...
export class UncompressedG1 implements StructClass { __StructClass = true as const;
 ...
 static readonly $typeName = `${PKG_V28}::bls12381::UncompressedG1`; static readonly $numTypeParams = 0; static readonly $isPhantom = [] as const;

 readonly $typeName = UncompressedG1.$typeName; readonly $fullTypeName: `${typeof PKG_V28}::bls12381::UncompressedG1`; readonly $typeArgs: []; readonly $isPhantom = UncompressedG1.$isPhantom;

 readonly dummyField: ToField<"bool">

 private constructor(typeArgs: [], fields: UncompressedG1Fields, ) { this.$fullTypeName = composeSuiType( UncompressedG1.$typeName, ...typeArgs ) as `${typeof PKG_V28}::bls12381::UncompressedG1`; this.$typeArgs = typeArgs;

 this.dummyField = fields.dummyField; }

 static reified( ): UncompressedG1Reified { return { typeName: UncompressedG1.$typeName, fullTypeName: composeSuiType( UncompressedG1.$typeName, ...[] ) as `${typeof PKG_V28}::bls12381::UncompressedG1`, typeArgs: [ ] as [], isPhantom: UncompressedG1.$isPhantom, reifiedTypeArgs: [], fromFields: (fields: Record<string, any>) => UncompressedG1.fromFields( fields, ), fromFieldsWithTypes: (item: FieldsWithTypes) => UncompressedG1.fromFieldsWithTypes( item, ), fromBcs: (data: Uint8Array) => UncompressedG1.fromBcs( data, ), bcs: UncompressedG1.bcs, fromJSONField: (field: any) => UncompressedG1.fromJSONField( field, ), fromJSON: (json: Record<string, any>) => UncompressedG1.fromJSON( json, ), fromSuiParsedData: (content: SuiParsedData) => UncompressedG1.fromSuiParsedData( content, ), fromSuiObjectData: (content: SuiObjectData) => UncompressedG1.fromSuiObjectData( content, ), fetch: async (client: SuiClient, id: string) => UncompressedG1.fetch( client, id, ), new: ( fields: UncompressedG1Fields, ) => { return new UncompressedG1( [], fields ) }, kind: "StructClassReified", } }
